...
" This file is used from vroom scripts to bootstrap the syncopate plugin and
" configure it to work properly under vroom.

" Syncopate does not support compatible mode.
set nocompatible
...
" |load-plugins| time.
call maktaba#plugin#Get('syncopate').Load()

" Load :TOhtml command (dependency of syncopate), normally loaded automatically
" at vim startup.
